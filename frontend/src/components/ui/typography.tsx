...
const textVariants = cva("text-foreground", {
  variants: {
    as: {
      ...
      h4: "scroll-m-20 md:text-xl font-semibold tracking-tight",
      h5: "scroll-m-20 text-lg font-semibold tracking-tight",
      h6: "scroll-m-20 text-sm md:text-base font-semibold tracking-tight",
      p: "leading-7 mt-p-8 text-sm md:text-[16px]",
